   ...
   <p className="text-xl font-semibold text-zinc-200 pt-2">EUL</p>
      ...
      <p className="text-zinc-200  px-8 text-base ">
       ...
       Our purpose is to reward holders by giving them portion on trading fees
         ...
         <p  className="text-zinc-200 mt-24 px-8 text-base ">CA : 0xB3f8de3a3C7ac402AAFC67c1198249D0D665DE28</p>
    <p className="text-zinc-200  px-8 text-base ">SUPPLY : 1B</p>
       <div className=" pt-8">
 ...
 Buy on Uniswap
  ...
  ❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔❔</p>
       ...
       <nav className="flex gap-3.5 items-center mt-32 max-w-full text-base w-[248px] max-md:mt-10">
         <a href="https://x.com/baseeul" className="grow self-stretch my-auto hover:underline focus:outline-none focus:ring-2 focus:ring-offset-2">
           twitter
         </a>
